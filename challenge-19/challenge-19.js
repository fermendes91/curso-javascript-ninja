(function () {
    ...
    */
    ...
    var justNumbersRegex = new RegExp('^\\d+', 'gm'); // ^ pega somente os que iniciam com números
    ...
    */
    ...
    var numbersAtTheEnd = new RegExp('\\d+$', 'gm'); // $ pega somente os que terminam com numeros
