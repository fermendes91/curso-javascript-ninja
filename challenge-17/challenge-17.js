...
(function () {
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, 'Fernando Mendes' ));
    ...
    */
    ...
    console.log(text.replace(/[D-Hd-h]/g, 0)); // entre letras maisculas e minusculas tem caracteres especiais, então devemos separar.
